...
-- Keybinds for netrw
--
vim.keymap.set('n', '<leader>ph', vim.cmd.Ex, { desc = 'Open netrw file explorer' })

vim.keymap.set('n', '<leader>dh', vim.cmd.Sex, { desc = 'Split horizontally' })
vim.keymap.set('n', '<leader>dv', vim.cmd.Vex, { desc = 'Split vertically' })

-- Editor commands
vim.keymap.set('n', '<leader>ac', 'gg<C-v>GGy', { desc = 'Copy current buffer into vim clipboard' })
vim.keymap.set('n', '<leader>"ac', 'gg<C-v>GG"+y', { desc = 'Copy current buffer into vim clipboard' })
